  ...
  create(context) {
    ...
    return {
      ImportDeclaration(node) {
        ...
        if(isForbiddenEntityCrossImport(context.getFilename(), normalizedImportPath)) {
          context.report(node, ENTITY_CROSS_IMPORT_ERROR);
          return;
        }
...
function isForbiddenEntityCrossImport(fromFilename, importPath) {
  ...
  return importApiSegment !== '@x' || importCrossTarget !== fromSlice;
}
